...
const Button = ({ className, label, disabled, loading, type, onClick, appearance }) => {
  return (
    <button
      className={`${className} ${appearance === "submit" && "bg-primary text-white"} h-11 font-[700] px-5 hover:opacity-90 transition text-[14px] rounded-md py-2 font-nunito flex items-center gap-1.5`}
